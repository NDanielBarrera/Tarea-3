...
## Descripción
Este proyecto se realiza para cumplir con la Tarea del Módulo 1 - Unidad 3 "Formulario interactivo con validación en clases". Tiene como objetivo la práctica avanzada de comandos JavaScript, como manipular DOM, creación y modificación de clases y objetos, etc.
